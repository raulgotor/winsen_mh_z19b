...
#ifndef WINSEN_MH_Z19B_H
#define WINSEN_MH_Z19B_H
...
typedef enum {
        MH_Z19B_ERROR_SUCCESS = 0,
        MH_Z19B_ERROR_ALREADY_INITIALIZED,
        MH_Z19B_ERROR_NOT_INITIALIZED,
        MH_Z19B_ERROR_BAD_PARAMETER,
        MH_Z19B_ERROR_GENERAL_ERROR,
        MH_Z19B_ERROR_IO_ERROR,
        MH_Z19B_ERROR_COUNT,
} mh_z19b_error_t;
...
mh_z19b_error_t mh_z19b_set_range(uint32_t const range);


#endif //WINSEN_MH_Z19B_H